...
fitsDir = '/Users/research/Desktop/sliceview_casa_2015-07-28/fits/'
psDir = '/Users/research/Desktop/sliceview_casa_2015-07-28/eps_betsey/'
...
gal_names = ('110482','111164','111946','111977','112521','174585','174605','182595','731457','748778','749237','749241')
noise_vals=(1.03,1.44,1.12,1.50,1.29,0.875,0.51,0.685,0.875,0.925,0.79,0.79)
#vcen=(357,163,367,207,274,356,351,398,454,258,372,451)
...
vrot=(25.,20.,17.5,17.5,20.,12.5,16.,15.,15.,12.5,40.,17.5)
...
for gal,noise,vc,vr in zip(gal_names,noise_vals,vcen,vrot):
    ...
    f = pyfits.open(fitsDir + gal+'.min.0.fits')
    hminor = f[0].header
